 ...
 */
public class G_Story3Canvas extends BaseSurface implements Runnable, Recycler {
    ...
    public G_Story3Canvas(Context context, Intent intent) {
        super(context);
        this.intent = intent;
...
//    }
    ...
    public void run() {
        ...
        bgSprite = new ShahSprite(Utility.decodeSampledBitmapFromResource(GlobalVariables.getResource, R.drawable.g_scene1bg02));
